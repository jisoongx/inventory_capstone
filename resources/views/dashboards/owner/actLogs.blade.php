...
<div class="relative mx-6">
    <div class="{{ ($expired || $plan === 3) ? 'blur-sm pointer-events-none select-none' : '' }}">
        <div class="flex justify-between items-center">
            <h1 class="text-xl font-semibold text-gray-900 mb-5">Activity Logs</h1>
        ...
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center gap-4 w-full">
            ...
            <div class="relative flex-1">
                <span class="material-symbols-rounded absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 text-[20px]">search</span>
                <input
                    type="text"
                    id="search"
                    placeholder="Search by location or activity"
                    class="w-full p-3 pl-11 text-sm text-gray-800 border border-gray-300 rounded-md shadow-md focus:border-indigo-500 transition-all duration-200" />
            </div>
            ...
            <div class="relative w-full sm:w-[180px]">
                <input
                    type="time"
                    id="timeFilter"
                    class="w-full p-3 text-sm text-gray-600 border border-gray-300 rounded-md shadow-md focus:border-indigo-500 transition-all duration-200" />
            </div>
