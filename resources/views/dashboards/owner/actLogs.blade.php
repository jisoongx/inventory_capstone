...
<div class="flex justify-between items-center mx-6">
    <h1 class="text-2xl font-extrabold text-gray-900 mb-6">My Activity Logs</h1>
    <a href="{{ route('staffLogs') }}" class="text-green-600 hover:text-green-800 underline text-sm">Staff Activity Logs</a>
</div>
...
<div class="overflow-x-auto bg-white shadow-md rounded-xl mx-6">
    <table class="min-w-full text-xs text-center text-gray-700">
        <thead class="bg-emerald-200 font-semibold">
            <tr>
