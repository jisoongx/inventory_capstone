...
<div class="md:p-4 space-y-5 ">
    ...
    @endif
        ...
        <!-- Restock Card -->
        <div class="{{ ($expired || $plan === 3) ? 'filter blur-sm pointer-events-none select-none' : '' }} relative bg-white rounded md:p-6 flex-1 flex flex-col md:flex-row items-center gap-4 md:gap-6 shadow-lg hover:shadow-xl transition-all duration-300">
