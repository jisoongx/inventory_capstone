...
<div class="p-4 md:p-6 space-y-6">
    ...
    <div class="flex flex-col md:flex-row gap-4 md:gap-6">
        ...
        <!-- Restock Card -->
        <div class="relative bg-white rounded-2xl p-4 md:p-6 flex-1 flex flex-col md:flex-row items-center gap-4 md:gap-6 shadow-lg hover:shadow-xl transition-all duration-300">
