...
@section('content')
    ...
    <div class="">
                    ...
                    <div class="px-8 py-12 text-center relative">
                        ...
                        <div class="relative z-10">
                            ...
                            <h2 class="text-xl md:text-md font-bold text-slate-800 mb-3">
                                Sales Performance Reports Available on Premium Plans
                            </h2>

                            <p class="text-slate-600 text-xs xs:text-base leading-relaxed mb-6">
                                Upgrade your subscription to access detailed daily, weekly, and monthly sales transactions, 
                                full product performance insights, and category-based sales breakdowns to guide smarter 
                                business decisions.
                            </p>
        ...
        @endif
        @livewire('masterlist-price-history')
    </div>
