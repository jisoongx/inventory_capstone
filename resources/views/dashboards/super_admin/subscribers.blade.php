            ...
            <div class="flex flex-col sm:flex-row gap-4">
                ...
                <div class="relative w-full sm:w-[180px]">
                    <input type="date" id="dateFilter" name="dateFilter"
                        class="appearance-none w-full p-3 pl-4 pr-4 text-sm text-gray-700 border border-gray-300 rounded-lg bg-white focus:ring-red-500 focus:border-red-500 shadow-sm transition-all duration-200 ease-in-out" />
                </div>
            </div>
        </div>
