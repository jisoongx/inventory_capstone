...
<div class="flex justify-between items-center mx-5 ">
    <h1 class="text-xl font-semibold text-gray-900 mb-5 ml-2">Staff Activity Logs</h1>
...
<div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4 mx-6">
    ...
    <div class="relative flex-1">
        ...
        <input
            ...
            autocomplete="off"
            class="w-full p-3 pl-11 text-sm text-gray-800 border border-gray-300 rounded-md bg-white focus:ring-gray-300 focus:border-gray-500 shadow-md transition-all duration-200 ease-in-out">
    </div>
    ...
    <div class="relative w-full sm:w-[180px]">
        <input
            ...
            id="timeFilter"
            name="timeFilter"
            class="appearance-none w-full p-3 pl-4 pr-10 text-sm text-gray-600 border border-gray-300 rounded-md focus:ring-gray-300 focus:border-gray-500 shadow-md transition-all duration-200 ease-in-out" />
    ...
    <div class="relative w-full sm:w-[180px]">
        <input
            ...
            id="dateFilter"
            name="dateFilter"
            class="appearance-none w-full p-3 pl-4 pr-4 text-sm text-gray-600 border border-gray-300 rounded-md focus:ring-gray-300 focus:border-gray-500 shadow-md transition-all duration-200 ease-in-out" />
    </div>


</div>

<div class="overflow-x-auto bg-white shadow-md rounded mx-6">
    <div class="max-h-[430px] overflow-y-auto">
        ...
        @endif">
                    ...
                    <td class="px-4 py-4 text-gray-600 text-center">
                        {{ $log->staff->firstname ?? 'N/A' }} {{ $log->staff->lastname ?? 'N/A' }}
                    </td>
