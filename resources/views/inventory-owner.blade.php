...
<div id="damageModal"
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md relative">
        <h2 class="text-xl font-bold mb-4 text-gray-800">Record Damaged Item</h2>

        <form action="{{ route('damaged.store') }}" method="POST">
            @csrf

            <!-- Product Dropdown -->
            <div class="mb-3">
                <label for="prod_code" class="block text-sm font-medium text-gray-700">Product</label>
                <select name="prod_code" id="prod_code" required
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:ring focus:ring-pink-200">
            ...
            <!-- Damaged Quantity -->
            <div class="mb-3">
                <label for="damaged_quantity" class="block text-sm font-medium text-gray-700">Quantity</label>
                <input type="number" name="damaged_quantity" id="damaged_quantity" required min="1"
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:ring focus:ring-pink-200">
            </div>

            <!-- Damaged Type -->
            <div class="mb-3">
                <label for="damaged_type" class="block text-sm font-medium text-gray-700">Damage Type</label>
                <select name="damaged_type" id="damaged_type" required
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:ring focus:ring-pink-200">
            ...
            <!-- Reason -->
            <div class="mb-4">
                <label for="damaged_reason" class="block text-sm font-medium text-gray-700">Reason</label>
                <textarea name="damaged_reason" id="damaged_reason" rows="3" required
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:ring focus:ring-pink-200"></textarea>
            </div>

            <!-- Buttons -->
            <div class="flex justify-end gap-2">
                <button type="button" id="cancelDamage"
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const openBtn = document.getElementById('damageBtn');
        const closeBtn = document.getElementById('cancelDamage');
