                                                            ...
                                                            <div class="flex items-start gap-2.5">
                                                                ...
                                                                <div class="relative mt-0.5">
                                                                    <input type="checkbox" wire:key="product-{{ $product->prod_code }}"
                                                                        ...
                                                                        @checked(isset($selectedProducts[$product->prod_code]['selected']) && $selectedProducts[$product->prod_code]['selected'])
                                                                        ...
                                                                        <div class="flex items-center gap-1">
                                                                            <button type="button"
                                                                                ...
                                                                                class="text-[10px] px-2 py-0.5 rounded border 
                                                                                    {{ ($selectedProducts[$prodCode]['bogo_type'] ?? false)
                                                                                        ? 'bg-green-500 text-white'
                                                                                        : 'bg-gray-100 text-gray-700' }}">
                                                                                {{ $bundleType === 'BOGO1' ? 'D' : 'F' }}
                                                                            </button>
                                                                        </div>
                                                                    @endif

                                                                    <!-- Remove Button -->
                                                                    <button wire:click="toggleProduct({{ $prodCode }})" 
