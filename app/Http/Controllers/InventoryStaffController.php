...
public function edit($prodCode)
{
    ...
    // Get price history with vat_category
...
public function update(Request $request, $prodCode)
{
    ...
    $finalVatCategory = $request->vat_category;
    ...
    $pricingChanged = ($product->cost_price != $finalCostPrice) || 
                      ($product->selling_price != $finalSellingPrice) ||
                      (isset($product->vat_category) && $product->vat_category != $finalVatCategory);
...
public function bulkRestock(Request $request)
{
    ...
    try {
        ...
        if ($updatePricing && $pricingProdCode && isset($priceChanged) && $priceChanged) {
            $successMessage .= ' and price has been updated';
        }
