...
class InventoryStaffSettingsController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('inventory-staff-settings', compact('categories', 'units'));
    }
    ...
    public function checkExistingName(Request $request)
    {
        ...
        if ($type === 'category') {
            ...
            $query = DB::table('categories')->where('owner_id', $owner_id);
            ...
            $query = DB::table('units')->where('owner_id', $owner_id);
