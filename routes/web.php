...
Route::get('/inventory/damage-items', [InventoryOwnerController::class, 'showDamageItemsForm'])->name('damage-items.form');
...
Route::get('/billing-history/owner', [BillingController::class, 'billingOwner'])->name('billing.history2');
